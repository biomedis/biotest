...
{
    /*
    private Map<String,BooleanItem> optionsBoolean=new HashMap<String,BooleanItem>();
    private Map<String,FloatItem> optionsFloat=new HashMap<String,FloatItem>();
    private Map<String,LongItem> optionsLong=new HashMap<String,LongItem>();
    private Map<String,IntItem> optionsInt=new HashMap<String,IntItem>();
    private Map<String,StringItem> optionsString=new HashMap<String,StringItem>();
    private Map<String,StringSetItem> optionsStringSet=new HashMap<String,StringSetItem>();
*/
    ...
    private AppOptions(Context ctx){

        preferences = ctx.getSharedPreferences("MAIN_PREFERENCES", Context.MODE_PRIVATE);
    ...
    /**
     * Создаст опцию в массиве, но не в файле
     * @param item
     * @return
     * @throws Exception
     */
    private OptionsItem createOption(OptionsItem item) throws Exception
    {
